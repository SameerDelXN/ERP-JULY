...
// import { Bell, ChevronDown, LayoutDashboard, Users,  CalendarCheck, CalendarOff, CreditCard , IndianRupeeIcon } from "lucide-react";
...
// // HR specific sidebar items with icons
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
              ...
              {profileOpen && (
                <div className="absolute right-0 top-12 w-56 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-200">
                  <div className="px-4 py-2 text-sm text-gray-700 border-b border-gray-100">
                    <p className="font-medium">HR User</p>
                    <p className="text-xs text-gray-500">hr@example.com</p>
                  </div>
                  {/* <button
        ...
        {/* Scrollable main area */}
        <main className="flex-1 overflow-y-auto pt-20 px-6 bg-white">{children}</main>
      </div>
    </div>
  );
};
