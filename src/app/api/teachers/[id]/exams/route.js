...
export async function POST(request) {
  try {
    ...
    const { type, subject, totalMarks, date, duration, year, semester, division, teacherId } = body

    console.log(type, subject, totalMarks, date, duration, year, semester, division);
