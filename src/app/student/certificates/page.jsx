                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className="w-full text-black px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none"
                                            required
                                        >
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="mt-6 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <h2 className="text-xl font-bold text-gray-800 mb-4">About Certificates</h2>
