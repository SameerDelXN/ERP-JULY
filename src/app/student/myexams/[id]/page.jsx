      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-6 text-center">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition-colors"
          >
            ...
            exam.map((question, index) => (
              ...
              >
                <h3 className="text-lg font-semibold text-gray-800 mb-4 flex">
                  <span className="inline-flex items-center justify-center w-8 h-8 bg-blue-100 text-blue-700 rounded-full mr-3 flex-shrink-0">
                    {index + 1}
                  </span>
