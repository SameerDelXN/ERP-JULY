...
import { superadminSidebarItems } from "@/data/data";
...
const Layout = ({ children }) => {
  ...
  const [activeTab, setActiveTab] = useState(superadminSidebarItems[0]?.id || "overview");
              ...
              <div className="relative">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 group-hover:scale-105 p-0.5 transition-transform duration-300">
                  <div className="w-full h-full rounded-full bg-white p-0.5">
                    <Avatar name={user?.username || "superadmin User"} />
                  </div>
                </div>
              </div>
                  ...
                  <div className="px-4 py-4 border-b border-gray-100/50">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        <p className="font-semibold text-gray-900">{user?.username || "superadmin User"}</p>
                        <p className="text-sm text-gray-500">{user?.email || "superadmin@company.com"}</p>
                      </div>
                    </div>
                  </div>
