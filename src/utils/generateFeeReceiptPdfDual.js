...
export async function generateFeeReceiptPDFDual(receiptData) {
  try {
    console.log('Generating DUAL PDF for receipt:', receiptData);
    ...
    // Generate PDF with A5 size for dual copies
    ...
    console.log('DUAL PDF generated successfully, size:', pdf.length);
