...
const pillarsData = [
  {
    ...
    description: "Centralized student access for aca-demics, attendance and applications."
  },
  {
    icon: <LineChart className="w-8 h-8" />,
    title: "Smart Analytics",
    description: "Real-time dashboardsfor performanc-e, growth tracking and insights."
  },
  {
    icon: <Folder className="w-8 h-8" />,
    title: "Course Management",
    description: "Organize subjects, timetables, ass-ignments and learning resources."
  },
  {
    icon: <CalendarCheck className="w-8 h-8" />,
    title: "Event Coordination",
    description: "Schedule seminars, exams, fests and automate notifications."
  },
  {
    icon: <ClipboardList className="w-8 h-8" />,
    title: "Project Tracking",
    description: "Monitor projects, submissions, eva-luation and approvals."
  },
];
...
export default function CircularPillars() {
  ...
  const getOuterText = (start, end, r) => {
    ...
    return {
      ...pos,
      anchor: pos.x > 50 ? "start" : pos.x < -50 ? "end" : "middle",
    };
  };
    ...
    <section className="py-16 bg-white" id="pillars">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-gray-600 mb-14 max-w-2xl mx-auto">
          The foundation modules that drive efficiency, innovation & seamless campus operations.
        </p>
        ...
        <div className="w-full max-w-4xl mx-auto">
          ...
          >
            ...
            {pillars.map((p, i) => {
              ...
              return (
                ...
                >
                  ...
                  <text x={textPos.x} y={textPos.y} fill="white"
                  ...
                  <text x={outer.x} y={outer.y - 8}
                    fill={isOn ? "#d4ff00" : "#0066ff"}
                  ...
                  <text x={outer.x} y={outer.y + 10}
                    fill={isOn ? "#000" : "#4B5563"}
                    fontSize="11" textAnchor={outer.anchor}
                  >
                    <tspan x={outer.x}>{p.description.slice(0,35)}</tspan>
                    <tspan x={outer.x} dy="12">{p.description.slice(35)}</tspan>
                  </text>
                </g>
              );
            })}
            ...
            <text x="0" y="-10" fontSize="16" fontWeight="500" textAnchor="middle">Five essential pillars</text>
            <text x="0" y="10" fontSize="16" fontWeight="500" textAnchor="middle">That Power Engineering</text>
            <text x="0" y="30" fontSize="16" fontWeight="500" textAnchor="middle">Excellence</text>
          </svg>
        </div>
      </div>
    </section>
