...
import User from './src/app/models/userSchema.js';
import teacherSchema from './src/app/models/teacherSchema.js';
import studentSchema from './src/app/models/studentSchema.js';
import { adminSidebarItems } from './src/data/data.js';
